            ...
            {dropdownOpen && (
              <div className="absolute mt-0 w-48 bg-white border border-black rounded-lg shadow-lg transform transition-all duration-300 ease-in-out">
                <ul className="py-2 list-none m-0">
                  ...
                  <li>
                    <Link href={{ pathname: '/posts', query: { category: 'GUIDES', neighborhood: 'ALL' } }} className="block px-4 py-3 font-bold font-serif text-md text-black hover:bg-yellow-600 hover:text-white transition-all duration-300 ease-in-out">
                      GUIDES
                    </Link>
                  </li>
                  <li>
